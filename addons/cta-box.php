<div class="cta-box">
    ...
    <b>Get Involved</b>
    <p> 
    Have questions about <?php echo $context_text; ?>, or want to join up? Drop us a line and we'll get in touch: <b><a href='mailto:hello@dsaneworleans.org'>hello@dsaneworleans.org</a>!</b>
    </p>
    <!--
    <form id="contact">
